    ...
    >
      ...
      <div className={`flex-1 flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <p className={`${styles.paragraph} mb-6 w-full`}>
          ...
          shipping and distribution company. My job mainly consisted of
          designing emails, homepage banners, and internal site banners.
          However, the creative interns were also tasked with a project to
          complete over the course of 2 months: creating a new welcome campaign
          targeted to a specific industry to improve new customer retention from
          that industry. I was only required to{' '}
          <span className="font-bold text-malibu-300">design new emails</span>{' '}
          and{' '}
          <span className="font-bold text-malibu-300">
            landing page banners
          </span>{' '}
          for the project, but I also took on the role of coding the landing
          pages and designing a print piece since we didn't have a web
          production or print design intern. I will describe the overview and
          process of this project, but unfortunately, cannot share all the
          specifics.
        </p>
        ...
        <div className="flex-1 flex flex-col lg:px-20 lg:pb-0 pb-10 pt-20">
          <img
            ...
            alt={'initialfinaldesign'}
            className="w-[100%] h-[100%] relative"
          />
          <p className={`${styles.subtext} mt-5`}>Final Designs</p>
        </div>
      </div>
    </section>
  )
