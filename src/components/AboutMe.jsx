  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* <button onClick={()=>{downloadFileAtURL(pdfFile)}} type="button" className={`mt-10 py-2 px-8 font-poppins cursor-pointer font-semibold text-[18px] text-malibu-300 rounded-[10px] border border-malibu-300 resume-button `}>
            Resume
        </button> */}

        {/* <p onClick={()=>{downloadFileAtURL(pdfFile)}} className="text-malibu-300 mt-6 flex cursor-pointer">
          View Resume
          <img src={arrowUp} alt="viewstudy" className="-translate-x-5 w-[70px] h-[18px] rotate-40 mt-1" />
        </p> */}

        {/* <p onClick={() => window.open("https://drive.google.com/file/d/1OHuqarcNXapF3gIT-WfRb6nOd6vDGxBq/view?usp=sharing")} className="text-malibu-300 mt-6 flex cursor-pointer font-bold">
          View Resume
          <img src={arrowUp} alt="viewstudy" className="-translate-x-5 w-[70px] h-[18px] rotate-40 mt-1" />
        </p> */}
        ...
        <button
          onClick={() =>
            window.open(
              'https://drive.google.com/file/d/1OHuqarcNXapF3gIT-WfRb6nOd6vDGxBq/view?usp=sharing',
            )
          }
          type="button"
        ...
        >
          View Resume
          <svg
            className="translate-x-2 w-[25px] h-[25x]"
