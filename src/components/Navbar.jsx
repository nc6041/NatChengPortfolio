...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        className="fixed w-screen bg-white z-10 flex py-3 md:py-6 px-8 sm:px-16 justify-between items-stretch navbar max-w-screen-xl mx-auto border-b border-b-gray-300"
        style={{
