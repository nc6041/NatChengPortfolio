...
export const navbarHeight = '128px'
const navbarHeightClass = 'h-32'
    ...
    <>
      <nav
        className={classNames(
          navbarHeightClass,
          'fixed w-screen bg-white z-10 flex py-6 px-8 sm:px-16 justify-between items-stretch navbar max-w-screen-xl mx-auto border-b border-b-gray-300',
        )}
      >
        <Link to="/">
          <div
      ...
      <div className={navbarHeightClass} />
    </>
  )
}
