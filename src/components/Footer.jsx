  ...
  <section className={`${styles.flexCenter} ${styles.paddingY} flex-col mb-3`}>
    ...
    <div className="w-full flex justify-center items-center md:flex-row flex-col pt-6">
      <div className="flex flex-row md:mt-0 mt-6">
        {/* facebook */}
        <svg
          className="mr-24 w-[45px] h-[45px] object-contain cursor-pointer text-primary fill-current hover:text-malibu-300"
          width="21"
          height="21"
          viewBox="0 0 21 21"
          fill="none"
        ...
        {/* X */}
        <svg
          className="w-[45px] h-[45px] object-contain cursor-pointer text-primary fill-current hover:text-malibu-300"
          width="1200"
          height="1227"
        ...
        {/* twitter */}
        {/* <svg className="w-[45px] h-[45px] object-contain cursor-pointer text-primary fill-current hover:text-malibu-300" width="23" height="19" viewBox="0 0 23 19" fill="none" xmlns="http://www.w3.org/2000/svg">
