  ...
  <section className={`${styles.flexCenter} ${styles.paddingY} flex-col mb-3`}>
    <div className={`flex-1 ${styles.flexCenter} flex-col xl:px-0 sm:px-16 px-6`}>
      ...
      <div className="flex flex-row justify-between items-center w-full">
        <h1 className="flex-1 text-primary font-nohemi font-medium text-center ss:text-[32px] text-[24px] text-dimBlack">
          Let's Talk!
        </h1>
      </div>
    ...
    <div className="w-full flex justify-center items-center md:flex-row flex-col pt-6">
      ...
      <div className="flex flex-row md:mt-0 mt-6">
        ...
        {/* facebook */}
        <svg className="mr-24 w-[45px] h-[45px] object-contain cursor-pointer text-primary fill-current hover:text-dimCyan" width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => window.open("https://www.facebook.com/natalie.cheng.545?mibextid=LQQJ4d")}>
        ...
        {/* linkedin */}
        <svg className="mr-24 w-[45px] h-[45px] object-contain cursor-pointer text-primary fill-current hover:text-dimCyan" width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => window.open("https://www.linkedin.com/in/natalie-cheng02")}>
        ...
        {/* X */}
        <svg className="w-[45px] h-[45px] object-contain cursor-pointer text-primary fill-current hover:text-dimCyan" width="1200" height="1227" viewBox="0 0 1200 1227" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => window.open("https://twitter.com/natchengdesigns")}>
          <path d="M714.163 519.284L1160.89 0H1055.03L667.137 450.887L357.328 0H0L468.492 681.821L0 1226.37H105.866L515.491 750.218L842.672 1226.37H1200L714.137 519.284H714.163ZM569.165 687.828L521.697 619.934L144.011 79.6944H306.615L611.412 515.685L658.88 583.579L1055.08 1150.3H892.476L569.165 687.854V687.828Z"/>
        </svg>

        {/* twitter */}
        {/* <svg className="w-[45px] h-[45px] object-contain cursor-pointer text-primary fill-current hover:text-dimCyan" width="23" height="19" viewBox="0 0 23 19" fill="none" xmlns="http://www.w3.org/2000/svg">
