...
const Hero = () => {
  return (
    <section
      id="home"
      className={`flex flex-col justify-center items-center mt-16 gap-3 relative w-full h-full pb-16 px-16 text-center`}
      style={{
    ...
    >
      ...
      <h1 className="font-nat text-9xl ss:leading-[100.8px] leading-[75px]">
        Hi,{' '}
